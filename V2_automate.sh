...
#create security groups 
      ...
      aws ec2 create-tags --resources $SECURITY_GROUP1_ID --tags Key=Name,Value=sec-grp-1


#authurize SSH
aws ec2 authorize-security-group-ingress --group-id $SECURITY_GROUP1_ID --protocol tcp --port 22 --cidr 0.0.0.0/0
        ...
        export SECURITY_GROUP2_ID
         aws ec2 create-tags --resources $SECURITY_GROUP2_ID --tags Key=Name,Value=sec-grp-2
...
#create key pair 
aws ec2 create-key-pair --key-name Key_auto --query 'KeyMaterial' --output text > Key_auto.pem

chmod 400 Key_auto.pem 
